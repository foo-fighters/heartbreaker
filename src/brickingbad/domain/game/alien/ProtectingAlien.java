...
public class ProtectingAlien extends Alien {
    ...
    public ProtectingAlien() {
        ...
        y = (rand.nextInt((int) GameConstants.alienAreaHeight - GameConstants.alienSize/2) + GameConstants.brickAreaHeight + GameConstants.menuAreaHeight + GameConstants.alienSize/2)/10;//should be in the brick area
